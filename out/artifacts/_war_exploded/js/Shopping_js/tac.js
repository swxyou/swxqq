!function (e) {
    ...
    !function () {
        ...
        !function () {
            ...
            function str(e, t) {
                ...
                switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
                    ...
                    case"object":
                        ...
                        if (rep && "object" == typeof rep) for (a = rep.length, o = 0; o < a; o += 1) "string" == typeof rep[o] && (n = rep[o], i = str(n, c), i && r.push(quote(n) + (gap ? ": " : ":") + i)); else for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (i = str(n, c), i && r.push(quote(n) + (gap ? ": " : ":") + i));
                        return i = 0 === r.length ? "{}" : gap ? "{\n" + gap + r.join(",\n" + gap) + "\n" + s + "}" : "{" + r.join(",") + "}", gap = s, i
                }
            }
            ...
            "function" != typeof JSON.stringify && (meta = {
                ...
                function walk(e, t) {
                    var o, n, i = e[t];
                    if (i && "object" == typeof i) for (o in i) Object.prototype.hasOwnProperty.call(i, o) && (n = walk(i, o), void 0 !== n ? i[o] = n : delete i[o]);
    ...
    !function () {
        var e = {
            domain: ".tuniu.com", path: "/", init: function () {
                this.key = +new Date, this.bindEvent(), this.getOS(), this.getCookieDomain(), this.IMAGE_URL = "//analy.tuniu.cn/analysisCollect/pcEvent.gif", this.postCache()
            }, postCache: function () {
                var e = this, t = e.getCache();
                if (t) {
                    t = JSON.parse(t);
                    for (var o = 0; o < t.length; o++) delete t[o].key;
                    var n = new Image;
                    n.onload = n.onerror = function () {
                        n = null, e.clearCache()
                    }, n.src = e.IMAGE_URL + "?" + e.makeQueryString(t)
                }
                ...
                var t = this, o = [], n = {
                    ...
                    storage: e,
                    co: "_taca =" + t.getCookie("_taca") + ";tuniuuser=" + t.getCookie("tuniuuser") + ";_tact=" + t.getCookie("_tact") + ";tuniu_partner=" + t.getCookie("tuniu_partner") + ";tuniuuser_id=" + t.getCookie("tuniuuser_id") + ";tuniuuser_citycode=" + t.getCookie("tuniuuser_citycode") + ";dfyoo_user_id=" + t.getCookie("dfyoo_user_id") + ";company_id=" + t.getCookie("company_id") + ";client_type=" + (t.os.phone ? 20 : 0)
                };
                for (var i in n) o.push(i + "=" + encodeURIComponent("string" == typeof n[i] ? n[i] : JSON.stringify(n[i])));
                return o.join("&")
            }, getSid: function () {
                var e, t = new Date, o = "" + t, n = "", i = "";
                o = o.substr(o.length - 8);
                for (var a = 0; a < o.length; a++) e = Math.floor(10 * Math.random()), i += e, n += o.charCodeAt(a) << e;
                return i + n
            }, getOS: function () {
                var e = navigator.userAgent, t = navigator.platform, o = this.os = {}, n = this.browser = {},
                    i = e.match(/Web[kK]it[\/]{0,1}([\d.]+)/), a = e.match(/(Android);?[\s\/]+([\d.]+)?/),
                    ...
                    g = e.match(/Windows Phone ([\d.]+)/), f = l && e.match(/TouchPad/),
                    m = e.match(/Kindle\/([\d.]+)/), p = e.match(/Silk\/([\d._]+)/),
                    h = e.match(/(BlackBerry).*Version\/([\d.]+)/), v = e.match(/(BB10).*Version\/([\d.]+)/),
                    k = e.match(/(RIM\sTablet\sOS)\s([\d.]+)/), w = e.match(/PlayBook/),
                ...
                var e = ".tuniu.com";
                /^https?:\/\/(\w*\.)?dfyoo\.com/.test(location.href) && (e = ".dfyoo.com"), this.domain = e
                ...
                var t = this;
                e = e || window.event;
                for (var o, n = e ? e.target : e.srcElement; n.parentNode && "BODY" != n.nodeName && "HTML" != n.nodeName;) (o = n.getAttribute("m")) && t.saveClick(o, e.clientX, e.clientY), n = n.parentNode
            }, clearCache: function () {
                var e = new Date;
                e.setDate(e.getDate() - 1), document.cookie = "clickCache=; expires=" + e.toUTCString() + "; domain=" + this.domain + "; path=" + this.path
            }, saveCache: function (e) {
                var t = new Date;
                t.setDate(t.getDate() + 7), document.cookie = "clickCache=" + encodeURIComponent(e) + "; expires=" + t.toUTCString() + "; domain=" + this.domain + "; path=" + this.path
            }, getCache: function () {
                return decodeURIComponent(this.getCookie("clickCache"))
            }, saveClick: function (e, t, o) {
                var n = this, i = {text: e, x: t, y: o, lg: +new Date}, a = n.getCache() || "[]";
                a = JSON.parse(a);
                for (var r = !1, s = 0; s < a.length; s++) if (a[s].key == n.key) {
                    r = !0, a[s].events.push(i);
                    break
                }
                r || a.push({
                    key: n.key,
                ...
                e.addEventListener ? e.addEventListener(t, o, !1) : e.attachEvent(t, o)
            }
        };
        e.init();
    ...
    !function (win) {
        var _tac = win._tac = win._tac || [], _tat = win._tat = win._tat || function () {
            ...
            function executePluginMethod(e, t) {
                var o, n, i = "";
                for (o in plugins) n = plugins[o][e], "function" == typeof n && (i += n(t));
                return i
            }
            ...
            function getParameter(e, t) {
                var o = new RegExp("^(?:https?|ftp)(?::/*(?:[^?]+)[?])([^#]+)"), n = o.exec(e),
                    i = new RegExp("(?:^|&)" + t + "=([^&]*)"), a = n ? i.exec(n[1]) : 0;
                return a ? unescapeWrapper(a[1]) : ""
            }
            ...
            function Tracker() {
                ...
                function getRequest() {
                    var e = "", t = "";
                    navigatorAlias.cookieEnabled && (e = getAnalysisCookie()), "undefined" == typeof analyTuniuBeginTime || isNaN(analyTuniuBeginTime) || (loadSpend = loginTime - analyTuniuBeginTime), "undefined" == typeof analyTuniuSpend || isNaN(analyTuniuSpend) || (executeSpend = Math.floor(1e3 * analyTuniuSpend)), pageName || (pageName = visitUrl.split("?")[0]);
                    var o = "";
                    return hasCookie("from_url") ? (o = getCookieWithOutUnescape("from_url"), delCookieSelf("from_url")) : o = escapeWrapper(fromUrl), t = "hw=" + browserHW + "&bt=" + browserType + "&bv=" + browserVersion + "&fu=" + o + "&lg=" + loginTime + "&co=" + e + "&vu=" + escapeWrapper(visitUrl) + "&sr=" + screenResolution + "&sc=" + screenColor + "&os=" + operatingSystem + "&fv=" + flashVersion + "&la=" + language + "&je=" + javaEnabled + "&ce=" + cookieEnabled + "&tn=&pn=" + escapeWrapper(escapeWrapper(pageName)) + "&clt=" + linkType + "&ev=" + isEvent + "&ei=" + eventId + "&ps=" + loadSpend + "&es=" + executeSpend
                }
                ...
                function getSid() {
                    var e, t = "" + loginTime, o = "", n = "";
                    t = t.substr(t.length - 8);
                    for (var i = 0; i < t.length; i++) e = Math.floor(10 * Math.random()), n += e, o += t.charCodeAt(i) << e;
                    return n + o
                }
                ...
                function isSiteHostName(e) {
                    ...
                    for (t = 0; t < configHostsAlias.length; t++) {
                        ...
                        if ("*." == o.substr(0, 2)) {
                            ...
                            if (n = e.length - o.length + 1, n > 0 && e.substr(n) == o.substr(1)) return !0
                        }
                    }
                    return !1
                }
                ...
                function getClassesRegExp(e, t) {
                    var o, n = "(^| )(piwik[_-]" + t;
                    if (isDefined(e)) for (o = 0; o < e.length; o++) n += "|" + e[o];
                ...
                function getLinkType(e, t, o) {
                    ...
                    return i.test(e) ? "link" : n.test(e) || a.test(t) ? "download" : 0
                }
                ...
                function clickHandler(e) {
                    ...
                    for (; (o = t.parentNode) && "A" != (n = t.tagName) && "AREA" != n;) t = o;
                    isDefined(t.href) && (a = t.hostname, r = a.toLowerCase(), s = t.href.replace(a, r), c = new RegExp("^(javascript|vbscript|jscript|mocha|livescript|ecmascript): *", "i"), c.test(s) || (i = getLinkType(t.className, s, isSiteHostName(r)), i && logLink(s, i)))
                }
                ...
                function getAnalysisCookie() {
                    ...
                    if (hasCookie(tacaName) && ("opera" === browserType && "" !== _opera_ta[0] ? (e += tacaName + "=" + _opera_ta[0] + ";", _opera_ta[0] = "") : e += tacaName + "=" + getCookie(tacaName) + ";"), hasCookie(tacbName) && ("opera" === browserType && "" !== _opera_ta[1] ? (e += tacbName + "=" + _opera_ta[1] + ";", _opera_ta[1] = "") : e += tacbName + "=" + getCookie(tacbName) + ";"), hasCookie(tacauName) && (e += tacauName + "=" + getCookie(tacauName) + ";"), hasCookie(tactName) && (e += tactName + "=" + getCookie(tactName) + ";"), hasCookie(taczName) && ("opera" === browserType && "" !== _opera_ta[2] ? (e += taczName + "=" + _opera_ta[2] + ";", _opera_ta[2] = "") : e += taczName + "=" + getCookie(taczName) + ";"), hasCookie("tuniu_partner") && (e += "tuniu_partner=" + getCookie("tuniu_partner") + ";"), hasCookie("tuniuuser") && (e += "tuniuuser=" + getCookie("tuniuuser") + ";"), hasCookie("tuniuuser_citycode") && (e += "tuniuuser_citycode=" + getCookie("tuniuuser_citycode") + ";"), hasCookie("tuniuuser_id") && (e += "tuniuuser_id=" + getCookie("tuniuuser_id") + ";"), hasCookie(dfyooUserCookieName) && (e += dfyooUserCookieName + "=" + getCookie(dfyooUserCookieName) + ";"), hasCookie(dfyooCompanyCookieName) && (e += dfyooCompanyCookieName + "=" + getCookie(dfyooCompanyCookieName) + ";"), null != navigatorAlias.userAgent && navigatorAlias.userAgent.length > 0 && (e += "userAgent=" + base64encode(escape(navigatorAlias.userAgent)) + ";"), "undefined" != typeof exposure && null != exposure && exposure.length > 0 && (e += "exposure=" + base64encode(escape(exposure)) + ";"), "undefined" != typeof abTest && null != abTest && 1 === abTest.length && (e += "abTest=" + abTest + ";"), "undefined" != typeof extendArray && extendArray instanceof Array) {
                        for (var t = [], o = 0; o < extendArray.length; o++) null != extendArray[o] && "" != trimStr(extendArray[o].toString()) && t.push(trimStr(extendArray[o].toString()));
                ...
                function getSearchKey() {
                    ...
                    e = new Array;
                    for (var n = 0; n < t.length; n++) if (fromUrl.indexOf(t[n]) > -1 && getQueryStringRegExp(fromUrl, o[n])) {
                        e[0] = t[n].replace(/(.*)(\.(com|cn|org).*)$/gi, "$1"), e[1] = getQueryStringRegExp(fromUrl, o[n]);
                        break
                    }
                    return e
                }
                ...
                function isSearchEnginePay() {
                    ...
                    e = new Array;
                    for (var n = 0; n < t.length; n++) if (t[n] == getQueryStringRegExp(visitUrl, tam_pay)) return mediumValue = "(cpc)", sourceValue = o[n], campaignValue = getQueryStringRegExp(visitUrl, tam_cmp) ? getQueryStringRegExp(visitUrl, tam_cmp) : getQueryStringRegExp(visitUrl, tam_campaign) ? getQueryStringRegExp(visitUrl, tam_campaign) : "(none)", e = getSearchKey(), termValue = 2 == e.length ? e[1] : "(none)", contentValue = getQueryStringRegExp(visitUrl, tam_content) ? getQueryStringRegExp(visitUrl, tam_content) : getQueryStringRegExp(visitUrl, kw) ? getQueryStringRegExp(visitUrl, kw) : "(none)", !0;
                    return !1
                }
                ...
                function setCookie(e, t, o, n, i) {
                    var a;
                    "opera" === browserType && ("_taca" === e ? _opera_ta[0] = t : "_tacb" === e ? _opera_ta[1] = t : "_tacz" === e && (_opera_ta[2] = t)), o && (a = new Date, a.setTime(a.getTime() + 36e5 * o)), documentAlias.cookie = e + "=" + escape(t) + (o ? ";expires=" + a.toGMTString() : "") + ";path=" + (n ? n : "/") + (i ? ";domain=" + i : "")
                }

                function resetCookie(e, t, o, n) {
                    var i = getCookie(e);
                    delCookie(e), setCookie(e, i, t, o, n)
                }

                function hasCookie(e) {
                    var t, o = documentAlias.cookie, n = 0, i = o.length;
                    for (e += "="; n < i;) {
                        if (t = n + e.length, o.substring(n, t) == e) return !0;
                        if (n = o.indexOf(" ", n) + 1, 0 == n) break
                    }
                    return !1
                }
                ...
                function delCookieSelf(e, t, o) {
                    ...
                    var n = new Date;
                    n.setTime(n.getTime() - 1), documentAlias.cookie = e + "=;domain=" + o + ";path=" + t + ";expires=" + n.toGMTString()
                }
                ...
                function getCookie(e) {
                    var t = getCookieWithOutUnescape(e);
                    return null !== t ? unescape(t) : null
                }
                ...
                function base64encode(e) {
                    e = utf16to8(e);
                    for (var t, o, n, i = "", a = 0, r = e.length, s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"; a < r;) {
                        if (t = 255 & e.charCodeAt(a++), a == r) {
                            i += s.charAt(t >> 2), i += s.charAt((3 & t) << 4), i += "==";
                            break
                        }
                        if (o = e.charCodeAt(a++), a == r) {
                            i += s.charAt(t >> 2), i += s.charAt((3 & t) << 4 | (240 & o) >> 4), i += s.charAt((15 & o) << 2), i += "=";
                            break
                        }
                        n = e.charCodeAt(a++), i += s.charAt(t >> 2), i += s.charAt((3 & t) << 4 | (240 & o) >> 4), i += s.charAt((15 & o) << 2 | (192 & n) >> 6), i += s.charAt(63 & n)
                    }
                    return i
                }
                ...
                function utf16to8(e) {
                    var t, o, n, i;
                    for (t = "", n = e.length, o = 0; o < n; o++) i = e.charCodeAt(o), i >= 1 && i <= 127 ? t += e.charAt(o) : i > 2047 ? (t += String.fromCharCode(224 | i >> 12 & 15), t += String.fromCharCode(128 | i >> 6 & 63), t += String.fromCharCode(128 | i >> 0 & 63)) : (t += String.fromCharCode(192 | i >> 6 & 31), t += String.fromCharCode(128 | i >> 0 & 63));
                    return t
                }
                ...
                var registeredHooks = {}, configTrackerPause = 500,
                    ...
                    url404Default = cpro + "//" + cPageNotFoundDomain + "/" + cPageNotFoundPage,
                    fromUrl = locationArray[2], visitUrl = locationArray[1], browserArray = getBrowser(),
                    ...
                    userAgent = navigatorAlias.userAgent.toLowerCase(),
                    browserTypeMatch = userAgent.match(/(?:firefox|opera|safari|chrome|msie|micromessenger)/),
                    browserType = browserTypeMatch && browserTypeMatch[0] ? browserTypeMatch[0] : "unknown",
                    browserVersionMatch = userAgent.match(/(?:firefox|opera|safari|chrome|msie|micromessenger)[\/: ]([\d.]+)/),
                    browserVersion = browserVersionMatch && browserVersionMatch[1] ? browserVersionMatch[1] : "unknown",
                    flashVersion = _uFlash(), javaEnabled = 1, language = "-",
            ...
            var expireDateTime, loginTime = setCurrentTime(), plugins = {}, hasLoaded = !1,
                registeredOnLoadHandlers = [], documentAlias = document, navigatorAlias = navigator,
                screenAlias = screen, windowAlias = window, escapeWrapper = windowAlias.encodeURIComponent || escape,
