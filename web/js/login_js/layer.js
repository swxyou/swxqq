!function (a, b) {
    ...
    var c, d, e = "", f = {
        getPath: function () {
            var a = document.scripts || document.getElementsByTagName('script'), b = a[a.length - 1].src;
    ...
    a.layer = {
        ...
        alert: function (a, b, d, e) {
            var f = "function" == typeof d, g = {dialog: {msg: a, type: b, yes: f ? d : e}, area: ["384px", "auto"]};
            return f || (g.title = d), c.layer(g)
        },
        confirm: function (a, b, d, e) {
            var f = "function" == typeof d, g = {dialog: {msg: a, type: 3, btns: 2, yes: b, no: f ? d : e}};
            return f || (g.title = d), c.layer(g)
        },
    ...
    h.pt = h.prototype, h.pt.config = {
        ...
        maxWidth: 400,
        dialog: {
            btns: 1, btn: ["确认", "取消"], type: 3, msg: "", yes: function (a) {
                layer.close(a)
            }, no: function (a) {
                layer.close(a)
            }
        ...
        iframe: {src: "http://www.tuniu.com", scrolling: "auto"},
        loading: {type: 3},
        ...
        switch (e.title ? 0 === e.type && layer.ie6 && j.css({width: i.outerWidth()}) : 4 !== e.type && i.find(".xubox_close").addClass("xubox_close0"), i.attr({type: f.type[e.type]}), b.offset(), 4 !== e.type && (e.shift && !layer.ie6 ? "object" == typeof e.shift ? b.shift(e.shift[0], e.shift[1] || 500, e.shift[2]) : b.shift(e.shift, 500) : i.css({
            top: b.offsetTop,
            left: b.offsetLeft
        })), e.type) {
            case 0:
                i.find(g[5]).css({"background-color": "#fff"}), e.title ? i.find(g[3]).css({paddingTop: 50 + j.outerHeight()}) : 7 === e.dialog.type ? (i.find(".xubox_msgico").css({
                    top: 45,
                    left: 50
                }), i.find(g[3]).css({
                    marginTop: 50,
                    marginBottom: 50,
                    paddingLeft: 95
                })) : (i.find(".xubox_msgico").css({top: 50, left: 50}), i.find(g[3]).css({
                    marginTop: 50,
                    marginBottom: 50,
                    paddingLeft: 80
                }));
