    ...
    (function ($) {
        ...
        Autocomplete.prototype = {
            killerFn: null, initialize: function () {
                ...
                var locationDiv = "", allPDiv = "", allproItemDiv = "", recommendDiv = "", freeFlyDiv = "",
                    ticketDiv = "", wifiDiv = "", visaDiv = "", hotelDiv = "", trainDiv = "", flightDiv = "",
                    hotCountryDiv = "", hotCityDiv = "", hotScenicDiv = "", nearScenicDiv = "", sameNameScenicDiv = "",
                    carDiv = "", playDiv = "", suggFroRbzDiv = "",
                    themeScenicDiv = "", themeCityDiv = "", themeCountryDiv = "", tourDayDiv = "";
                var mai = this.suggestions, pro = mai.allProducts, rec = mai.recommend, diy = mai.freeFly,
                    tic = mai.ticket, wi = mai.wifi, vi = mai.visa,
                    hotel = mai.hotel, tra = mai.train, fli = mai.flight, hc = mai.hotCountry, hCity = mai.hotCity,
                    hs = mai.hotScenic, ns = mai.nearScenic, sn = mai.sameNameScenic,
                    newHotel = mai.hotelAggreRst, car = mai.carRst, play = mai.destPlay,
                    suggFroRbz = mai.suggestFromRbz,
                    themeScenic = mai.themeScenic, themeCity = mai.themeCity, themeCountry = mai.themeCountry,
                    keyType = mai.keyType, tourDay = mai.tourDayHot;
                var alldiv = "";
