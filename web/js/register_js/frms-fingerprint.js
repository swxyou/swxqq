...
(function () {
    ...
    function Fa() {
        ...
        if (0 < a) for (var b = 0; b < a; b++) {
            ...
            if (0 < k.pv[0]) {
                var f = J(c);
                if (f) if (!ha(M[b].swfVersion) || k.wk && 312 > k.wk) if (M[b].expressInstall && Da()) {
                    e = {};
    ...
    var S = [], R = R.SHA256 = sa.extend({
        _doReset: function () {
            ...
            for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], g = c[3], h = c[4], k = c[5], n = c[6], l = c[7], m = 0; 64 > m; m++) {
                ...
                v = l + ((h << 26 | h >>> 6) ^ (h << 21 | h >>> 11) ^ (h << 7 | h >>> 25)) + (h & k ^ ~h & n) + eb[m] + S[m];
    ...
    var V, I = window, p = document, N = navigator, gb = !1, la = [function () {
        ...
        }], M = [], ia = [], T = [], X, ka, Ca, Ua, P = !1, ja = !1, L, ya, Ra = !0, k,
    ...
    k = {w3: Ab, pv: ea, wk: Db, ie: La, win: Bb, mac: Cb};
    k.w3 && (("undefined" != typeof p.readyState &&
        "complete" == p.readyState || "undefined" == typeof p.readyState && (p.getElementsByTagName("body")[0] || p.body)) && U(), P || ("undefined" != typeof p.addEventListener && p.addEventListener("DOMContentLoaded", U, !1), k.ie && k.win && (p.attachEvent("onreadystatechange", function b() {
    ...
    V = {
        registerObject: function (a, b, c, d) {
            ...
            k.w3 && !(k.wk && 312 > k.wk) && a && b && c && d && e ? (O(b, !1), Wa(function () {
                    ...
                    if (ha(e)) u = za(m, k, b), m.id == b && O(b, !0), l.success = !0, l.ref = u; else {
                        if (f && Da()) {
                            m.data = f;
                            Ba(m, k, b, p);
                            return
            ...
            if (ja) {
                ...
                a && X && (a.parentNode.replaceChild(X, a), ka && (O(ka, !0), k.ie && k.win && (X.style.display = "block")), Ca && Ca(Ua));
                ja = !1
            }
        }
    };
            ...
            this.ec.get("BSFIT_OkLJUJ", function () {
                b.getDfpMoreInfo(function () {
                    if (!(9E5 < F("BSFIT_EXPIRATION") - (new Date).getTime() & null != F("BSFIT_DEVICEID") & void 0 != F("BSFIT_DEVICEID") & !b.NeedUpdate())) {
                        for (var a = "", e = "", f = b.getpackStr(""), g = [], h = [], k = [], p = [], l = 0; l < f.length; l++) "new" != f[l].value && -1 == qb.indexOf(f[l].key) && (-1 != rb.indexOf(f[l].key) ? h.push(f[l]) : -1 != sb.indexOf(f[l].key) ? k.push(f[l]) : -1 != tb.indexOf(f[l].key) ? p.push(f[l]) : g.push(f[l]));
                        f = "";
                        ...
                        for (k = 0; k < g.length; k++) p = g[k].key.replace(RegExp("%",
                            "gm"), ""), h = "", h = "string" == typeof g[k].value ? g[k].value.replace(RegExp("%", "gm"), "") : g[k].value, "" !== h && (e += p + h, h = encodeURIComponent(h), a += "\x26" + (void 0 == $a[p] ? p : $a[p]) + "\x3d" + h);
                        e = xa(e);
                        e = xa(e);
                        ...
                        Za.getJSON("https://frms-new-api.tuniu.cn/public/generate/jsonp" +
                            ("?algID\x3djhzqvYOtUD\x26hashCode\x3d" + e + a), null, function (a) {
                            var c = JSON.parse(a);
...
/*T56*/
var /*KJ*/__dlA/*Rhiq*/ = \u0053\u0074\u0072\u0069\u006e\u0067/*Xr0*/./*dv*/\u0066r\u006fm\u0043ha\u0072C\u006fde/*Ej*/;
var /*MRcr*/_x_FD4 = [/*FM*/161, 2945, 252, 2257, 1939, /*q9*/];
var /*5vx*/_$TmVT/*UZ*/ = /*Jo*/function (/*lBh*/) {/*6R*/
    return /*fIC*/arguments[/*oE*/0] ^ /*gP*//*TrWp*/_x_FD4[/*vdM*/0];
    /*oN6*/
}/*qE*/;
var /*dejh*/_$86C/*F7*/ = /*fof*/function (/*cd*/) {/*l1B*/
    return /*iZ*/arguments[/*d5*/0] ^ /*I4nX*//*J7*/_x_FD4[/*iVY*/1];
    /*c8k*/
}/*oEQK*/;
var /*EzYH*/_$XSC2/*U99*/ = /*cY*/function (/*eUj*/) {/*Vgd*/
    return /*Kal*/arguments[/*C1*/0] ^ /*UnK1*//*s71a*/_x_FD4[/*WlzT*/2];
    /*CzS*/
}/*P3s*/;
var /*duE*/_$uAcl/*2D*/ = /*U3*/function (/*Kjc*/) {/*u4Uz*/
    return /*mH*/arguments[/*C7*/0] ^ /*7C*//*l3h1*/_x_FD4[/*pAzA*/3];
    /*YuA*/
}/*4O*/;
var /*75Q*/_$0IOP/*Q4F*/ = /*ASBK*/function (/*wXdb*/) {/*Eczk*/
    return /*Ta*/arguments[/*ZpP7*/0] ^ /*mO*//*K4*/_x_FD4[/*uMi*/4];
    /*wy*/
}/*uIc4*/;
/*ka*/
\u0065\u0076\u0061\u006c/*Mr*/(__dlA(32/*0ybCh8N*/));
/*aHK*/